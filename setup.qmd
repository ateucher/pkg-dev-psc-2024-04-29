...
Create a PAT using these instructions: https://docs.gitlab.com/ee/user/profile/personal_access_tokens.html#create-a-personal-access-token. We suggest the following scopes for this token: api, read_api, read_user, create_runner, read_repository, write_repository.
